    ...
    return (
        <NavigationContainer>
            <Stack.Navigator>
                ...
                <Stack.Screen name="Order" options={{ presentation: 'modal', headerShown: false }} component={OrderScreen} />
                <Stack.Screen name="Address" options={{ presentation: 'modal', headerShown: false }} component={AddressScreen} />
            </Stack.Navigator>
        </NavigationContainer>
    );
}
